...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".Header-parent {\n    width: 100%;\n    height: 40px;\n    display: flex;\n    align-items: center;\n}\n\n.Header-text {\n    margin: 24px;\n}", "",{"version":3,"sources":["webpack://src/styles/header.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,YAAY;IACZ,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,YAAY;AAChB","sourcesContent":[".Header-parent {\n    width: 100%;\n    height: 40px;\n    display: flex;\n    align-items: center;\n}\n\n.Header-text {\n    margin: 24px;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.ed703b55c19ff2b42bd6.hot-update.js.map