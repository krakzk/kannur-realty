...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".Header-parent {\n    width: 100%;\n    height: 90%;\n    display: flex;\n    align-items: center;\n}\n\n.Header-text {\n    margin: 24px;\n}", "",{"version":3,"sources":["webpack://src/styles/header.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,WAAW;IACX,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,YAAY;AAChB","sourcesContent":[".Header-parent {\n    width: 100%;\n    height: 90%;\n    display: flex;\n    align-items: center;\n}\n\n.Header-text {\n    margin: 24px;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.f7c34a22d53875359b17.hot-update.js.map